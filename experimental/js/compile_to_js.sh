...
${EMCC} -lembind -O3 -I../../ -I../../deps/miniz binding.cc ../../deps/miniz/miniz.c -s ALLOW_MEMORY_GROWTH=1 -s MODULARIZE=1 -s EXPORT_ES6=0 -s ENVIRONMENT=web -o tinyexr.wasm.js
