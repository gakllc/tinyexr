...
${EMCC} -lembind -g -O2 -I../../ -I../../deps/miniz binding.cc ../../deps/miniz/miniz.c -s ALLOW_MEMORY_GROWTH=1 -s MODULARIZE=1 -s EXPORT_ES6=0 -s DEMANGLE_SUPPORT=1 -s ENVIRONMENT=web -o tinyexr.wasm.js
# ${EMCC} -lembind -O2 -I../../ -I../../deps/miniz binding.cc ../../deps/miniz/miniz.c -s ALLOW_MEMORY_GROWTH=1 -s MODULARIZE=1 -s EXPORT_ES6=0 -s ENVIRONMENT=web -o tinyexr.wasm.js
